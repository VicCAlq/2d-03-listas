...
// Array na linha abaixo
 const frutas = [
    "maçã", "banana", "laranja", "uva", "pêra", "manga"
 ]
...
*/
// Operações necessárias e resposta a partir da linha abaixo
export const resposta02 = frutas.length
...
// Operações necessárias e resposta a partir da linha abaixo
let temp = frutas[2]
export const resposta05 = [frutas[2],frutas[5]] =
[frutas[5],frutas[2]]
...
*/
// Operações necessárias e resposta a partir da linha abaixo
export const resposta07 = [numeros[0],numeros[1],numeros[2],numeros[3],numeros[4],numeros[5],numeros[6]] = [numeros[1],numeros[2],numeros[3],numeros[4],numeros[5],numeros[6],numeros[0]]
