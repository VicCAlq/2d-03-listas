...
export const frutas = [maca, banana, laranja, useDebugValue, pera, manga]
...
*/
// Operações necessárias e resposta a partir da linha abaixo
export const resposta03 = frutas[frutas[3]] = "abacaxi"
...
*/
// Operações necessárias e resposta a partir da linha abaixo
export const resposta04 = frutas[frutas.length] = "limao"
...
// Operações necessárias e resposta a partir da linha abaixo
export const numeros =  [7, 2, 4, 9, 8, 6, 1]
numero[0] * numero[5]
