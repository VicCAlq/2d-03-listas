...
let profissoes = []
profissoes.push("programador(a)", "designer", "engenheiro(a)", "veterinário",
   "administrador(a)")
...
*/
// Operações necessárias e resposta a partir da linha abaixo
let temp = profissoes.pop()

export const resposta02 = temp
...
*/
// Operações necessárias e resposta a partir da linha abaixo
let primeiraProfissao = profissoes.shift()

export const resposta04 = primeiraProfissao
...
*/
// Operações necessárias e resposta a partir da linha abaixo
let profissoesRemovidas = ["administrador(a)", "programador(a)"]
