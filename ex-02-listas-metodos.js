...
*/
// Operações necessárias e resposta a partir da linha abaixo
let profissaoRemovida = profissoes.shift()
export const resposta04 = profissaoRemovida
...
*/
// Operações necessárias e resposta a partir da linha abaixo
let profissiones = [itemRemovido, profissaoRemovida]
profissoes = profissoes.concat(profissiones)
...
*/
// Operações necessárias e resposta a partir da linha abaixo
let carangueijo = animais.pop()
let formiga = animais.pop()
let polvo = animais.pop()
animais.unshift(polvo, formiga, carangueijo)
...
// Operações necessárias e resposta a partir da linha abaixo
animais.reverse()
let porcoespinho = animais.shift()
let leopardo = animais.shift()
let elefante = animais.shift()
animais.push(porcoespinho)
...
*/
// Operações necessárias e resposta a partir da linha abaixo
let zirconio = pedras.shift()
let obsidiana = pedras.shift()
let jade = pedras.shift()
pedras.push(zirconio, obsidiana, jade)
pedras.reverse()
