...
- [Formato dos exercícios](#formato-dos-exerccios)
- [Instruções da atividade](#instrues-da-atividade)
- [Dicas](#dicas)
...
1. As questões se encontram nos arquivos abaixo:
    - `ex-01-listas-indices.js`
    - `ex-02-listas-metodos.js`
...
7.  A quantidade total de exercícios é de 24 questões:  
        - 10 do arquivo ex-01-listas-indices.js  
        - 14 do arquivo ex-02-listas-metodos.js  
8.  Cada exercício vale um máximo de 5 pontos de um total de 10 para a atividade
9.  A quantidade mínima de questões corretas para garantir os 5 pontos 
    para cada exercício é de:  
        - 7 questões corretas para o arquivo ex-01-listas-indices.js  
        - 10 questões corretas para o arquivo ex-02-listas-metodos.js  
