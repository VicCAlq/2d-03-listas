...
let listaConcat = profissoes.concat(removidos)
...
*/
// Operações necessárias e resposta a partir da linha abaixo
let ultimo1 = animais.pop()
let ultimo2 = animais.pop()
let ultimo3 = animais.pop()

animais.unshift(ultimo3)
animais.unshift(ultimo2)
animais.unshift(ultimo1)
...
for (let i = 0; i < 6; i++) {
  removidosPedras.push(pedras.pop())
}

export const resposta14 = removidosPedras
