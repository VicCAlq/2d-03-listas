...
export const resposta01 = frutas[1]; // "banana" (índice 1 é o segundo item)
...
*/
// Operações necessárias e resposta a partir da linha abaixo
export const resposta02 = frutas[frutas.length - 1]; // "manga"
...
*/
// Operações necessárias e resposta a partir da linha abaixo
frutas[3] = "abacaxi"; // Altera "uva" para "abacaxi"
