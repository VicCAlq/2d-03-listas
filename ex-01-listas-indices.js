...
*/
// Operações necessárias e resposta a partir da linha abaixo
export const resposta02 = frutas[frutas-1]
...
*/
// Operações necessárias e resposta a partir da linha abaixo
numeros;[numeros[0],numeros[6]]=[numeros[6],numeros[0]];
numeros;[numeros[1],numeros[6]]=[numeros[6],numeros[1]];
numeros;[numeros[2],numeros[6]]=[numeros[6],numeros[2]];
numeros;[numeros[3],numeros[6]]=[numeros[6],numeros[3]];
numeros;[numeros[4],numeros[6]]=[numeros[6],numeros[4]];
numeros;[numeros[5],numeros[6]]=[numeros[6],numeros[5]];
...
numeros;[numeros[1],numeros[4]]=[numeros[4],numeros[1]];
numeros;[numeros[3],numeros[6]]=[numeros[6],numeros[3]];
numeros;[numeros[5],numeros[1]]=[numeros[1],numeros[5]];
