...
let profissoes = [];
profissoes.push("programador", "designer", "engenheiro", "veterinário", "administrador");
export 
const resposta01 = profissoes;
...
*/
// Operações necessárias e resposta a partir da linha abaixo
let profissaoRemove = profissoes.pop(); 
export const resposta02 = profissaoRemove;
...
*/
// Operações necessárias e resposta a partir da linha abaixo
let profissaoShift = profissoes.shift();
export const resposta04 = profissaoShift;
...
*/
// Operações necessárias e resposta a partir da linha abaixo
let profissoesRemovidas = [profissoesRemove, profissaoShift]
let lista =  profissoes.concat(profissoesRemovidas)
...
*/
// Operações necessárias e resposta a partir da linha abaixo
animais = animais.conscat("carcará", "morcego", "salmão");
animais.reverse();
